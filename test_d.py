...
model = network_d.model(im_size, int_steps=10)
...
for i, data in enumerate(testloader, 0):
    ...
    predict_ptv, predict_flow = model.forward(source_slice_c, source_slice_s, target_slice_c, target_slice_s, source_ptv)
