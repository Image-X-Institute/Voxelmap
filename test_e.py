import os
import numpy as np
from utilities import network_e, losses, spatialTransform
...
for i, data in enumerate(testloader, 0):
    (source_real_c, source_imag_c, source_real_s, source_imag_s, target_real_c, target_imag_c, target_real_s,
     target_imag_s, source_vol, source_ptv, source_eso, source_sto,
     source_lungL, source_lungR, source_spcord, target_vol, target_ptv, target_eso, target_sto, target_lungL,
     target_lungR, target_spcord, angle) = \
    ...
    predict_ptv, predict_flow = vxm_model.forward(source_real_c, source_imag_c, source_real_s, source_imag_s, target_real_c,
                                            target_imag_c, target_real_s, target_imag_s, source_ptv)
